...
//		areaField.getSelectionModel().select("西安");
	...
	private void handleQueryCustomer()
	{
		...
		else
		{
			...
			if(("".equals(customerName.trim())) && (!"请选择".equals(rank)))
			{
				List<Customer> customersByRank = sqlSession.selectList("com.xidian.CustomerXml.getCustomerByRank", rank);
			...
			if((!"".equals(customerName.trim())) && ("请选择".equals(rank)))
			{
				List<Customer> customersByName = sqlSession.selectList("com.xidian.CustomerXml.getCustomerByName", customerName);
			...
			if((!"".equals(customerName.trim())) && (!"请选择".equals(rank)))
			{
				...
				List<Customer> customersByRankAndName = sqlSession.selectList("com.xidian.CustomerXml.getCustomerByRankAndName", customer);
